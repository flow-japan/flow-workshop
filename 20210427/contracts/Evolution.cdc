...
pub contract Evolution: NonFungibleToken {
    ...
    pub struct Item {
        ...
        init(metadata: {String: String}) {
            ...
            Evolution.nextItemId = Evolution.nextItemId + 1 as UInt32
    ...
    pub struct SetData {
        ...
        init(name: String, description: String?) {
            ...
            Evolution.nextSetId = Evolution.nextSetId + 1 as UInt32
    ...
    pub resource Set {
        ...
        pub fun mintCollectible(itemId: UInt32): @NFT {
            ...
            let newCollectible: @NFT <- create NFT(serialNumber: minted + 1 as UInt32,
                                              itemId: itemId,
                                              setId: self.setId)

            // Increment the count of Collectibles minted for this Item
            self.numberMintedPerItem[itemId] = minted + 1 as UInt32
    ...
    pub resource NFT: NonFungibleToken.INFT {
        ...
        init(serialNumber: UInt32, itemId: UInt32, setId: UInt32) {
            ...
            Evolution.totalSupply = Evolution.totalSupply + 1 as UInt64
    ...
    pub resource Admin {
        ...
        pub fun startNewSeries(): UInt32 {
            Evolution.currentSeries = Evolution.currentSeries + 1 as UInt32
